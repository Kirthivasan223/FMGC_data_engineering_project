...
df_products = spark.table("fmgc_data.2_silver.products") 
...
df_gold_price = spark.table("fmgc_data.1_gold.sb_dim_gross_price")
...
delta_table = DeltaTable.forName(spark, "fmgc_data.1_gold.dim_gross_price")
